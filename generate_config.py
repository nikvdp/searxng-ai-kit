...
def main():
    ...
    parser.add_argument("--metadata", required=True, help="Path to build metadata JSON file")
    ...
    parser.add_argument("--tag", help="GitHub release tag (auto-generated if not provided)")
    parser.add_argument("--wheel-filename", help="Wheel filename (extracted from metadata if not provided)")
